...
//MatchStrategy in some cases it might be better to fetch parent View data and all Relation data in the same time
//and merge it on the backend side in those cases ReadAll strategy will do that.
//in other cases it might be better to filter Relation data and fetch only those records that matches with View data
