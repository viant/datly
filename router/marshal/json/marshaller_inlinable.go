...
func newInlinableMarshaller(field reflect.StructField, config common.IOConfig, path, outputPath string, dTag *DefaultTag, cache *marshallersCache) (*inlinableMarshaller, error) {
