...
- [Observability](product/datly/doc/observability.md): native capture exists;
...
- [Cache/warmup](product/llm/datly-reader/references/cache-and-operations.md): independent AFS/Aerospike
...
- [API documentation](product/datly/doc/api-documentation.md): preserve explicit
...
- [Custom output/finalizers](product/llm/datly-custom-component/references/output-and-operations.md): candidate SDK
...
regression remains required. Use [formats](product/datly/doc/selectors-and-formats.md)
