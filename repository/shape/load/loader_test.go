...
func TestLoader_LoadComponent_SynthesizesMutableHelpersForPatchBodyRoute(t *testing.T) {
	...
	assert.Equal(t, "*struct { Values []int \"json:\\\",omitempty\\\"\" }", artifact.Resource.Parameters.Lookup("CurFoosId").Schema.DataType)
	...
	assert.Equal(t, state.One, artifact.Resource.Parameters.Lookup("CurFoosId").Schema.Cardinality)
...
func TestLoader_LoadComponent_SynthesizesMutableHelpersForPatchManyBodyRoute(t *testing.T) {
	...
	assert.Equal(t, state.One, curFoosID.Schema.Cardinality)
	assert.Equal(t, state.One, curFoosID.Output.Schema.Cardinality)
	assert.Equal(t, "*struct { Values []int \"json:\\\",omitempty\\\"\" }", curFoosID.Schema.DataType)
