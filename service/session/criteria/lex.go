...
import (
	matcher3 "github.com/viant/datly/service/session/criteria/matcher"
...
var fieldMatcher = parsly.NewToken(keywordToken, "GetField", matcher3.NewIdentity())

var booleanMatcher = parsly.NewToken(booleanToken, "Boolean", matcher.NewFragments([]byte("true"), []byte("false")))
var intMatcher = parsly.NewToken(intToken, "Int", matcher3.NewIntMatcher())
var numericMatcher = parsly.NewToken(numericToken, "Float", matcher.NewNumber())
var stringMatcher = parsly.NewToken(stringToken, "String", matcher3.NewStringMatcher('\''))
var timeMatcher = parsly.NewToken(timeToken, "Time", matcher3.NewStringMatcher('\''))
