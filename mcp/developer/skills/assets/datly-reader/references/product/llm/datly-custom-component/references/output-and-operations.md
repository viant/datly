...
- [Async](../../datly-writer/references/mutation-messages.md#async-and-dry-run): original DATLY_JOBS schema, AFS events,
...
- [Cache/warmup](../../../../cache-and-operations.md): AFS/Aerospike are
...
- [Mutation limits](../../datly-writer/references/writer-contract.md): stable IDs precede Queue;
