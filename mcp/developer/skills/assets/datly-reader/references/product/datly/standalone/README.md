...
see [project builds](references/product/datly/doc/project-build.md). For application-owned embedding,
...
derived tools when enabled. [Report guidance](references/product/datly/doc/reports.md) covers linked
...
auth signer/provider/secret-to-environment options and extended metadata endpoints. [Configured async](references/product/datly/standalone/ASYNC.md) starts existing application job services
