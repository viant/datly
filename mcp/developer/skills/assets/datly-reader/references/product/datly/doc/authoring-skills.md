...
[All guides](references/product/datly/doc/README.md) · [Coverage](references/product/datly/doc/feature-skill-coverage.md)

The canonical `llm` source contains three application-authoring skills:
[datly-reader](SKILL.md),
[datly-writer](references/product/llm/datly-writer/SKILL.reference.md), and
[datly-custom-component](references/product/llm/datly-custom-component/SKILL.reference.md).
...
gaps. See [release status](references/product/datly/doc/status.md) for the current validation boundaries.
...
see [protocols](references/product/datly/doc/protocols.md#developer-mcp-and-final-sep-2640-skills).
