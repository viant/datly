...
[All guides](references/product/datly/doc/README.md) · [Readers](references/product/datly/doc/readers.md)
...
and registration path when embedding; [report registration tests](references/product/datly/report/registration_test.go.txt)
...
This body comes from the [HTTP/MCP composition fixture](references/product/datly/report/compose_integration_test.go.txt).
...
awaits final code delivery and review. See [cache acceptance](references/product/datly/doc/cache-and-warmup.md).
...
schemas. [Grouped tests](references/product/datly/report/grouped_sqlite_test.go.txt) and
[composition tests](references/product/datly/report/cubecompose/sqlite_test.go.txt) provide concrete cases.
