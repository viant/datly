...
See the [reader contract](references/reader-contract.md)
...
zero and nullable bounds are NULL. The [complete Go and DQL examples](references/reader-examples.md#complete-go-shape-pattern-one-row-pages-full-match-count-and-bounds)
