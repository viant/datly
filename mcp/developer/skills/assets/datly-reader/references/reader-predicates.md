...
Use the [complete predicate guide](product/datly/doc/reader-predicates.md) for scoped AND/OR readers, optional bounds, present-zero markers, repeated parameters and the custom-handler/JWT example.
