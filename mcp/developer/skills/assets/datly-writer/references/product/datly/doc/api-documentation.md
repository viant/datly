...
[All guides](references/product/datly/doc/README.md) · [Protocols](references/product/datly/doc/protocols.md)
...
The [OpenAPI tests](references/product/datly/application/openapi_test.go.txt) and
[description loader](references/product/datly/transcribe/description.go.txt) are the current source evidence.
...
[direct-byte transport support](references/product/datly/doc/custom-handlers.md#return-already-shaped-bytes)
