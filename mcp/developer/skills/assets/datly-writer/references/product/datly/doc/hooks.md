...
[All guides](references/product/datly/doc/README.md) · [DQL grammar](references/product/datly/doc/dql.md) · [Readers](references/product/datly/doc/readers.md) · [Mutations](references/product/datly/doc/mutations.md)
...
See the implemented [reader hook dispatch](references/product/datly/sql/reader/hooks.go.txt),
[reader service](references/product/datly/sql/reader/service.go.txt) and
[batched hook tests](references/product/datly/sql/reader/batch_runtime_sqlite_test.go.txt).
...
[the typed hooks fixture](references/product/datly/transcribe/testdata/mutationhooks/model.go.txt) for real
...
See [mutations](references/product/datly/doc/mutations.md) for the complete validation/transaction contract and
[custom handlers](references/product/datly/doc/custom-handlers.md) for injector-aware finalization and output behavior.
