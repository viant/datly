...
[All guides](references/product/datly/doc/README.md) · [Runnable setup](references/product/datly/README.md#try-a-typed-api-locally)
...
The fixture sources are [component](references/product/datly/project/build/testdata/app/records/component.go.txt),
[hook](references/product/datly/project/build/testdata/app/hooks/write.go.txt) and
[model](references/product/datly/project/build/testdata/app/models/record.go.txt). The setup script changes
...
Use [datly init/build](references/product/datly/doc/project-build.md) with your module and real dependency
