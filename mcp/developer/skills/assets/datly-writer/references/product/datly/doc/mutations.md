...
The [writer examples](references/writer-examples.md) and
[writer contract](references/writer-contract.md) carry the
...
if the original entity had no allocated ID. The [complete message-hook pattern](references/mutation-messages.md)
