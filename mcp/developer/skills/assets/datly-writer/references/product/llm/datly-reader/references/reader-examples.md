...
separately. Default filenames are plain; [exact overrides and optional prefixes](references/product/llm/datly-reader/references/developer-mcp.md#operation-based-generation-to-pure-go)
