...
- [Async](../../datly-writer/references/mutation-messages.md#async-and-dry-run): original 34-column job schema, AFS events, canonical replay/current authorization, explicit HTTP controls, cache-only result inspection and limited reader dryrun.
