...
[writer-contract.md](references/product/llm/datly-writer/references/writer-contract.md), [writer-examples.md](references/product/llm/datly-writer/references/writer-examples.md)
and the explicit [JWT pattern](references/product/llm/datly-writer/references/tags-and-interfaces.md#jwt-input-and-authorization-predicates)
...
an absent scalar zero is not evidence. See the [identity and read-index contract](references/product/llm/datly-writer/references/writer-contract.md#6-original-identity-and-sparse-presence).
...
Use the existing [message-hook reference](references/product/llm/datly-writer/references/mutation-messages.md) for typed bus
...
- [Custom output/finalizers](references/output-and-operations.md): candidate SDK
...
Use [developer MCP](references/product/llm/datly-writer/references/developer-mcp.md) for the seven candidate tools,
...
Use [project build](references/product/llm/datly-writer/references/project-build.md) for automatic traversal and linking,
