...
are configured as in the [standalone guide](references/product/datly/standalone/README.md):
...
`async=true` query parameter is installed. See [the async guide](references/product/datly/doc/async.md)
