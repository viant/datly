...
[All guides](references/product/datly/doc/README.md) · [HTTP and MCP](references/product/datly/doc/protocols.md)
...
columns are application-specific. The [full authored reference](references/product/llm/datly-reader/references/tags-and-interfaces.md#jwt-input-and-authorization-predicates)
...
The job authorizer must refresh current access. See [async limits](references/product/datly/doc/async.md).
