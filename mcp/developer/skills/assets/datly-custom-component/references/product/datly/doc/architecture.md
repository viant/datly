...
[All guides](references/product/datly/doc/README.md)
...
[Transcribe](references/product/datly/transcribe/compiler.go.txt) discovers selected packages and DQL,
...
translator architecture. See [authoring](references/product/datly/doc/authoring.md).
...
| Datly source/package authority and precedence | [typecatalog](references/product/datly/typecatalog/INDEX.md) |
| Typed row mapping and native read cache services | SQLX `io/read` |
| Reader collection, relation policy and SQL build inputs | [sql/reader](references/product/datly/sql/reader/INDEX.md), [sql/builder](references/product/datly/sql/builder/INDEX.md) |
| Mutation policy and custom orchestration | Handler semantic compilation and application handlers |
| Artifact assembly and protected regeneration | [transcribe/generate](references/product/datly/transcribe/generate/INDEX.md) |
| Generation publication and owned background lifetime | [application](references/product/datly/application/INDEX.md) |
| HTTP/MCP protocol adaptation | [gateway](references/product/datly/gateway/INDEX.md), [mcp](references/product/datly/mcp/INDEX.md) |
...
under still-running handlers. [Configuration](references/product/datly/doc/configuration.md) and
[async](references/product/datly/doc/async.md) describe those operational boundaries.
