...
The [quickstart](references/product/datly/doc/quickstart.md) shows a linked reader with a required path input
...
See the [reader contract](references/product/llm/datly-reader/references/reader-contract.md)
...
zero and nullable bounds are NULL. The [complete Go and DQL examples](references/product/llm/datly-reader/references/reader-examples.md#complete-go-shape-pattern-one-row-pages-full-match-count-and-bounds)
...
not a universal combination of every feature. Read [warmup limits](references/product/datly/doc/cache-and-warmup.md)
before relying on full-projection cache reuse, and [observability](references/product/datly/doc/observability.md)
