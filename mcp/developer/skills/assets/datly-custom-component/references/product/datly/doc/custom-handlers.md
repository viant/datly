...
The [greeting example](references/custom-examples.md#typed-application-owned-handler)
...
The [forwarding example](references/custom-examples.md#explicit-typed-forwarding-and-trusted-service-registration)
