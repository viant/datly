...
server policy. See [protocols](references/product/datly/doc/protocols.md) and
[canonical packaging](references/product/datly/doc/authoring-skills.md).
...
remain [source-backed](references/product/datly/doc/project-build.md#deployment-contract).
