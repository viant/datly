...
[All guides](references/product/datly/doc/README.md) · [Hook flow diagrams](references/product/datly/doc/hooks.md) · [DQL grammar](references/product/datly/doc/dql.md) · [Errors and custom output](references/product/datly/doc/errors-and-output.md)
...
[entity synchronization generator](references/product/datly/transcribe/handler/golang/entity_sync.go.txt).
...
refinements. Read the [DQL grammar](references/product/datly/doc/dql.md#rich-cast-pseudo-fields-and-tag-customization)
and [mutation rules](references/product/datly/doc/mutations.md) for the projection/validation boundaries.
...
[The complete flow and hook table](references/product/datly/doc/hooks.md#generated-writer-flow) shows the order.
...
See [errors and output](references/product/datly/doc/errors-and-output.md) for client-facing handling.
