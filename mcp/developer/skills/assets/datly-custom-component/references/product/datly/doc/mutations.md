...
[All guides](references/product/datly/doc/README.md) · [Custom handlers](references/product/datly/doc/custom-handlers.md)
...
The [writer examples](references/product/llm/datly-writer/references/writer-examples.md) and
[writer contract](references/product/llm/datly-writer/references/writer-contract.md) carry the
...
this documentation. See the [implementation status](references/product/datly/doc/status.md).
...
compound-constraint discovery. [Status](references/product/datly/doc/status.md) records the release boundary.
...
if the original entity had no allocated ID. The [complete message-hook pattern](references/product/llm/datly-writer/references/mutation-messages.md)
...
The [demo writer](references/product/datly/standalone/testdata/app/records/records.go.txt) proves a simple
...
writes. Canonical source/provenance [async replay](references/product/datly/doc/async.md) is present in the candidate;
