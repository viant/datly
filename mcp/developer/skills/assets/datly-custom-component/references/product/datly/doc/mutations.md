...
[All guides](references/product/datly/doc/README.md) · [Programming model](references/product/datly/doc/programming-model.md) · [DQL grammar](references/product/datly/doc/dql.md) · [Reader/writer diagrams](references/product/datly/doc/hooks.md)
...
1. [Choose the writer product](references/product/datly/doc/mutations.md#choose-the-writer-product)
2. [Describe the writable graph](references/product/datly/doc/mutations.md#describe-the-writable-graph)
3. [Transcribe and inspect generated code](references/product/datly/doc/mutations.md#transcribe-and-inspect-generated-code)
4. [Understand the complete lifecycle](references/product/datly/doc/mutations.md#understand-the-complete-lifecycle)
5. [Separate the four kinds of state](references/product/datly/doc/mutations.md#separate-the-four-kinds-of-state)
6. [Use Has markers for sparse requests](references/product/datly/doc/mutations.md#use-has-markers-for-sparse-requests)
7. [Understand SyncPresence](references/product/datly/doc/mutations.md#understand-syncpresence)
8. [Backfill invariant groups](references/product/datly/doc/mutations.md#backfill-invariant-groups)
9. [Customize the writing hooks](references/product/datly/doc/mutations.md#customize-the-writing-hooks)
10. [Inject services and publish messages](references/product/datly/doc/mutations.md#inject-services-and-publish-messages)
11. [Control errors](references/product/datly/doc/mutations.md#control-errors)
12. [Shape custom output](references/product/datly/doc/mutations.md#shape-custom-output)
13. [Understand finalizer selection](references/product/datly/doc/mutations.md#understand-finalizer-selection)
14. [Sequence IDs and reconcile foreign keys](references/product/datly/doc/mutations.md#sequence-ids-and-reconcile-foreign-keys)
15. [Regenerate and test](references/product/datly/doc/mutations.md#regenerate-and-test)
...
The order is implemented by the [mutation adapter](references/product/datly/runtime/handler/mutation/adapter.go.txt)
...
See [errors and custom output](references/product/datly/doc/errors-and-output.md) for complete response examples.
...
See [async jobs](references/product/datly/doc/async.md) for replay and completion boundaries.
