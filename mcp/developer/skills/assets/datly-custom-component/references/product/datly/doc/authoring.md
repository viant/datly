...
mechanism for sparse mutation policy; see [mutations](references/product/datly/doc/mutations.md).
...
See the [maintained grammar](references/product/llm/datly-reader/references/dql-grammar.md)
and [rich-shape examples](references/product/llm/datly-reader/references/reader-examples.md#rich-public-shape).
