...
[existing examples](references/custom-examples.md) and
[verified JWT input/predicate pattern](references/tags-and-interfaces.md#jwt-input-and-authorization-predicates).
...
- [Linked configuration](references/project-build.md): `run`/`start` need
...
- [Async](references/product/llm/datly-writer/references/mutation-messages.md#async-and-dry-run): original DATLY_JOBS schema, AFS events,
...
- [Mutation limits](references/product/llm/datly-writer/references/writer-contract.md): stable IDs precede Queue;
...
Use [project build](references/project-build.md) for automatic traversal/internal
...
[developer MCP](references/developer-mcp.md) for declared Final SEP-2640 skills,
